...
class BaseHttpClient:
    ...
    def get(self, path: str, params: Optional[Dict[str, str]]) -> Optional[Any]:
        print(f"DEBUG: called BaseHttpClient.get({path}, {params})")
        ...
        try:
            ...
            print(f"ERROR: Error occurred making GET request to {url}: {http_error}")
        except requests.RequestException as request_exception:
            print(f"ERROR: Error occurred making GET request to {url}: {request_exception}")
